...
class _Joblisting_Screen extends State<Joblisting_Screen> {
              ...
              children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xff5D5D67), width: 1),
                ...
                Container(
                  ...
                  child: Expanded(
                    child: items.isNotEmpty
                        ? ListView.builder(
                            itemBuilder: (context, index) => custom_listtile(
                                title: items[index].job_title,
                                desc: items[index].job_desc,
                                icon1: Icons.edit_outlined,
                                icon2: Icons.delete_outline,
                                on_icon1_press: () => onedit(
                                    context,
                                    index,
                                    JobPost_Model(items[index].job_title,
                                        items[index].job_desc)),
                                on_icon2_press: () => ondelete(context, index)),
  ...
  void onedit(BuildContext context, int index, JobPost_Model jobPost_Model) {
    Navigator.of(context)
        .push(MaterialPageRoute(
            builder: (_) => Editjob_Screen(JobPost: jobPost_Model)))
        .then((value) => setState(() {
  ...
  showAlertDialog(BuildContext context, int index) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Do You Want To Remove ${items[index].job_title} Job?",
